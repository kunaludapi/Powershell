...
<Window 
        ...
        Title="MainWindow" Height="470" Width="800" Background="Black" Icon="C:\Temp\MetroDarkTheme\grayicon.ico">
        <Window.Resources>
             <ResourceDictionary>
                <ResourceDictionary.MergedDictionaries>
                    <ResourceDictionary Source="C:\Temp\MetroDarkTheme\MetroDark.MSControls.Core.Implicit.xaml"/>
                    <ResourceDictionary Source="C:\Temp\MetroDarkTheme\Styles.WPF.xaml"/>
                    <ResourceDictionary Source="C:\Temp\MetroDarkTheme\Theme.Colors.xaml"/>
                    <ResourceDictionary Source="C:\Temp\MetroDarkTheme\Styles.Shared.xaml"/>
                </ResourceDictionary.MergedDictionaries>
                    ...
                    <Setter Property="Template">
                        <Setter.Value>
                            <ControlTemplate TargetType="TabItem">
                                <Border Name="Border" BorderBrush="DarkGray" BorderThickness="0,0,1,0">
    ...
    <Grid>
        ...
        <DataGrid Name='Datagrid' HorizontalAlignment="Left" Height="100" Margin="10,175,0,0" VerticalAlignment="Top" Width="229" Background='Black' ColumnHeaderStyle="{StaticResource HeaderStyle}" RowBackground = 'Black'/>
        ...
        <TabControl Name='TabControl' HorizontalAlignment="Left" Height="100" Margin="507,175,0,0" VerticalAlignment="Top" Width="275">
        ...
        <Label Content="ProgressBar" HorizontalAlignment="Left" Margin="570,280,0,0" VerticalAlignment="Top" Width="212"/>
        <ProgressBar HorizontalAlignment="Left" Height="27" Margin="570,316,0,0" VerticalAlignment="Top" Width="212" IsIndeterminate="True"/>
        <ProgressBar HorizontalAlignment="Left" Height="24" Margin="570,348,0,0" VerticalAlignment="Top" Width="212" Value='60'/>
